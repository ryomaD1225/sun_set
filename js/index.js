...
// document.addEventListener('mousemove', function(e){ 
  document.addEventListener('DOMContentLoaded', function(){ 
    var dt = new Date();
    if(dt.getHours()===0)mouse.x=window.parent.screen.width,mouse.y=window.parent.screen.height;
    if(dt.getHours()===1)mouse.x=(window.parent.screen.width/6*5).toFixed(1),mouse.y=window.parent.screen.height;
    if(dt.getHours()===2)mouse.x=(window.parent.screen.width/6*4).toFixed(1),mouse.y=window.parent.screen.height;
    if(dt.getHours()===3)mouse.x=(window.parent.screen.width/6*3).toFixed(1),mouse.y=window.parent.screen.height;
    if(dt.getHours()===4)mouse.x=(window.parent.screen.width/6*2).toFixed(1),mouse.y=window.parent.screen.height;
    if(dt.getHours()===5)mouse.x=(window.parent.screen.width/6*1).toFixed(1),mouse.y=window.parent.screen.height;
    if(dt.getHours()===6)mouse.x=0,mouse.y=window.parent.screen.height;
    if(dt.getHours()===7)mouse.x=0,mouse.y=(window.parent.screen.height/6*5).toFixed(1);
    if(dt.getHours()===8)mouse.x=0,mouse.y=(window.parent.screen.height/6*4).toFixed(1);
    if(dt.getHours()===9)mouse.x=0,mouse.y=(window.parent.screen.height/6*3).toFixed(1);
    if(dt.getHours()===10)mouse.x=0,mouse.y=(window.parent.screen.height/6*2).toFixed(1);
    if(dt.getHours()===11)mouse.x=0,mouse.y=(window.parent.screen.height/6*1).toFixed(1);
    if(dt.getHours()===12)mouse.x=0,mouse.y=0;
    if(dt.getHours()===13)mouse.x=(window.parent.screen.width/6*1).toFixed(1),mouse.y=0;
    if(dt.getHours()===14)mouse.x=(window.parent.screen.width/6*2).toFixed(1),mouse.y=0;
    if(dt.getHours()===15)mouse.x=(window.parent.screen.width/6*3).toFixed(1),mouse.y=0;
    if(dt.getHours()===16)mouse.x=(window.parent.screen.width/6*4).toFixed(1),mouse.y=0;
    if(dt.getHours()===17)mouse.x=(window.parent.screen.width/6*5).toFixed(1),mouse.y=0;
    if(dt.getHours()===18)mouse.x=window.parent.screen.width,mouse.y=0;
    if(dt.getHours()===19)mouse.x=window.parent.screen.width,mouse.y=(window.parent.screen.height/6*1).toFixed(1);
    if(dt.getHours()===20)mouse.x=window.parent.screen.width,mouse.y=(window.parent.screen.height/6*2).toFixed(1);
    if(dt.getHours()===21)mouse.x=window.parent.screen.width,mouse.y=(window.parent.screen.height/6*3).toFixed(1);
    if(dt.getHours()===22)mouse.x=window.parent.screen.width,mouse.y=(window.parent.screen.height/6*4).toFixed(1);
    if(dt.getHours()===23)mouse.x=window.parent.screen.width,mouse.y=(window.parent.screen.height/6*5).toFixed(1);
    // mouse.x = e.clientX || e.pageX; 
    // mouse.y = e.clientY || e.pageY;
    console.log(window.parent.screen.width) //スクリーン幅を取得
    console.log(window.parent.screen.height) //スクリーン高さを取得
      updateDimensions();
